package segments{
	...
	public class centipedeSegment extends MovieClip {
		...
		public var myMaxMutations = 3;
		public var myMaxRequirements = 3;
		...
		public function centipedeSegment(xin,yin,heightin,degreein,followThis,atSpeed,startFrame,health,lead) {
			this.x = xin;
			this.y = yin;
